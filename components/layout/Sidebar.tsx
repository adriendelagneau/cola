...
export default function Sidebar() {
  ...
  return (
    <div
      ref={sidebarRef}
      className="bg-secondary text-primary fixed inset-0 z-[999] flex flex-col -translate-x-full"
    >
      {/* HEADER */}
      ...
      <div className="flex flex-1 p-12">
        ...
        <div
          ref={imageAreaRef}
          className="hidden lg:flex flex-1 items-center justify-center overflow-hidden border m-22"
        >
          {/* image will appear here */}
          <div className="text-sm opacity-50 ">image area</div>
        </div>
      ...
      <div className="overflow-hidden p-8">
        <div
          ref={socialRef}
          className="flex justify-center gap-8 lg:gap-10 translate-y-full opacity-0"
        >
          {/* Facebook */}
